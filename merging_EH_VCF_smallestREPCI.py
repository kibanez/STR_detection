            ...
            try:
                ...
                if r.ALT != [None]:
                    ...
                    if len(str(hash_fields.get('RU', 0))) >= 3:
                        ...
                        smallest_ci_1 = hash_fields['REPCI'].split('/')[0].split('-')[0]
                        smallest_ci_2 = hash_fields['REPCI'].split('/')[1].split('-')[0]
                        ...
                        if hash_variant.get('gt') == '0/0':
                            ...
                            allele_ref = smallest_ci_1
                            allele_alt = smallest_ci_2
                            ...
                            allele_alt1 = smallest_ci_1
                            allele_alt2 = smallest_ci_2
